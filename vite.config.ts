...
const repositoryName = process.env.GITHUB_REPOSITORY?.split('/')[1] ?? 'pebbo';
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Pebbo',
        short_name: 'Pebbo',
        description: 'Mascota virtual amable para jugar y cuidar.',
        theme_color: '#7dd3fc',
      ...
      injectManifest: { globPatterns: ['**/*.{js,css,html,svg,png,ico,json}'] },
